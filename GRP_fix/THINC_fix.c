 ...
 double *rho[], double *u[], double *p[], runList *runhist, char *scheme)
{
  int i = 0, j = 0, k = 1, it = 0;  /* j is a frequently used index for
				     ...
				     * step.
				     */
  char scheme_local[50] = "THINC-prim\0";
  printf("===========================\n");
  ...
  running_info[1] = 0.0;
  running_info[1] = 0.0;
  THINC_primitive_0(running_info, m, h, thickness, rho[0], u[0], p[0], rho_L, rho_R, u_L, u_R, p_L, p_R, D_rho_L, D_rho_R, D_u_L, D_u_R, D_p_L, D_p_R, trouble);
...
//==================================================
    ...
    running_info[1] = T;
    running_info[2] = 0.0;
    THINC_primitive_0(running_info, m, h, thickness, rho[vk1], u[vk1], p[vk1], rho_L, rho_R, u_L, u_R, p_L, p_R, D_rho_L, D_rho_R, D_u_L, D_u_R, D_p_L, D_p_R, trouble);
 ...
 double *rho[], double *u[], double *p[], runList *runhist, char *scheme)
{
  int i = 0, j = 0, k = 1, it = 0;  /* j is a frequently used index for
				     ...
				     * step.
				     */
  char scheme_local[50] = "THINC-consv\0";
  printf("===========================\n");
  printf("The scheme [%s] started.\n", scheme_local);
  int len = 0;
  while(scheme_local[len] != '\0')
  ...
  running_info[1] = 0.0;
  running_info[1] = 0.0;
  THINC_conservative_0(running_info, m, h, thickness, gamma-1.0, rho[0], mom, ene, rho_L, rho_R, u_L, u_R, p_L, p_R, D_rho_L, D_rho_R, D_u_L, D_u_R, D_p_L, D_p_R, trouble);
...
//==================================================
    ...
    running_info[1] = T;
    running_info[2] = 0.0;
    THINC_conservative_0(running_info, m, h, thickness, gamma-1.0, rho[vk1], mom, ene, rho_L, rho_R, u_L, u_R, p_L, p_R, D_rho_L, D_rho_R, D_u_L, D_u_R, D_p_L, D_p_R, trouble);
